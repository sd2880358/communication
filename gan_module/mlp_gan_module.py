...
def train_step(total, label):
    with tf.GradientTape(persistent=True) as tape:
        ...
        total_loss = gen_loss+identity_g_loss + identity_s_loss

    gradients_of_s_generator = tape.gradient(total_loss, generator_s.trainable_variables)
    gradients_of_i_generator = tape.gradient(total_loss, generator_i.trainable_variables)
    gradients_of_n_generator = tape.gradient(total_loss, generator_n.trainable_variables)
...
checkpoint_path = "./checkpoints/test6"
